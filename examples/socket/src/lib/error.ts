...
// preventRetry: the "and don't try this again" flag Point0's client honors (queries stop retrying, a denied
// connect/join sits out the reconnect cycles) — public by default, the client acts on it over the wire
