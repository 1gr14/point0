...
import { default as unnamed_4, createIdeaMutation as createIdeaMutation_13, generateIdeaMutation as generateIdeaMutation_14 } from '../pages/idea-create.js'
...
import { clientCtx1 as clientCtx1_10, clientCtx2 as clientCtx2_11, clientCtx3 as clientCtx3_12 } from './client-ctx.js'
export default [
  root_0,
  unnamed_1,
  empty_2,
  ...
  clientCtx2_11,
  clientCtx3_12,
  createIdeaMutation_13,
  generateIdeaMutation_14,
