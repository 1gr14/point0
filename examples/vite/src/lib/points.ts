...
export const empty_1rjbmai8jv3_lazy = {
  type: 'page',
  name: 'empty',
  route: '/empty',
...
export const ideasPage_dpnga3tq2p_lazy = {
  type: 'page',
  name: 'ideas',
  route: '/ideas',
  layouts: ['generalLayout'],
...
export const unnamed_27vj7ksc8uv_lazy = {
  type: 'page',
  name: 'newIdea',
  route: '/ideas/new',
  layouts: ['generalLayout'],
...
export const ideaPage_11pn5ng24s0_lazy = {
  type: 'page',
  name: 'idea',
  route: '/ideas/:id',
...
export const ideasNewsPage_1n1kanafn9f_lazy = {
  type: 'page',
  name: 'ideaNews',
  route: '/ideas/:id/news',
  layouts: ['generalLayout', 'ideaLayout'],
...
export const generalLayout_8layzlgx3_lazy = {
  type: 'layout',
  name: 'generalLayout',
  route: '/',
...
export const ideaLayout_2566t8kz9ue_lazy = {
  type: 'layout',
  name: 'ideaLayout',
  route: '/ideas/:id',
