# Point0 — basic example

A small ideas board built with Point0 — SSR, Prisma + SQLite, Tailwind, and
type-safe routing, bundled with Bun. It shows points: pages, layouts, queries,
and mutations wired together.
