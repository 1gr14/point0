...
import {
  createIdeaMutation as createIdeaMutation_2,
  ideaQuery as ideaQuery_3,
  ideasQuery as ideasQuery_4,
} from '../../ideas.js'
export default [root_0, ideaScreenComponent_1, createIdeaMutation_2, ideaQuery_3, ideasQuery_4] as PointsDefinition<
