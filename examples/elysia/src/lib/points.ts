...
export const empty_1hkfpsw8bf8_lazy = {
  type: 'page',
  name: 'empty',
  route: '/empty',
...
export const sharedEmptyPage_2fpm0morg6d_lazy = {
  type: 'page',
  name: 'sharedEmpty',
  route: '/empty/shared',
  shouldBePrefetchedOnLinkHover: false,
...
export const unnamed_1ou1x35w0ni_lazy = {
  type: 'page',
  name: 'home',
  route: '/home',
  shouldBePrefetchedOnLinkHover: false,
...
export const ideasPage_1ph5cjq2lcy_lazy = {
  type: 'page',
  name: 'ideas',
  route: '/ideas',
  shouldBePrefetchedOnLinkHover: false,
...
export const unnamed_12ssc61x8py_lazy = {
  type: 'page',
  name: 'newIdea',
  route: '/ideas/new',
  shouldBePrefetchedOnLinkHover: false,
...
export const ideaPage_lgqlupqrd2_lazy = {
  type: 'page',
  name: 'idea',
  route: '/ideas/:id',
  shouldBePrefetchedOnLinkHover: false,
...
export const ideasNewsPage_1199g1po7xm_lazy = {
  type: 'page',
  name: 'ideaNews',
  route: '/ideas/:id/news',
  shouldBePrefetchedOnLinkHover: false,
...
export const generalLayout_1x5fgy0uzab_lazy = {
  type: 'layout',
  name: 'generalLayout',
  route: '/',
...
export const ideaLayout_1uzidssunaw_lazy = {
  type: 'layout',
  name: 'ideaLayout',
  route: '/ideas/:id',
