import type { LazyPointsModule, ParsedUrl, PointsScope, ReadyPointsModule, RequiredCtx } from '@point0/core'
import { prependAndDeappendSlash, PointsManager } from '@point0/core'
