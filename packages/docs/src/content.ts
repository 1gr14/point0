...
/**
 * Prebuilt docs + embeddings, generated at package build time by `scripts/build-content.ts` and shipped inside the
 * package. Lives next to the compiled output: `<pkg>/content/docs.json`.
 */
